...
import com.andre.mc.services.ClienteService;
...
public class ClienteResource {
	...
	public ResponseEntity<List<ClienteDTO>> findAll() {
		...
		List<ClienteDTO>listDto = list.stream().map(obj -> new ClienteDTO(obj)).collect(Collectors.toList());//convete list em um listDto padrao do  java
