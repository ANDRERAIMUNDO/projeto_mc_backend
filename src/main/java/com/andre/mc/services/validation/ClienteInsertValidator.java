package com.andre.mc.services.validation;
...
import com.andre.mc.resources.exception.FieldMessage;
import com.andre.mc.services.validation.utils.BR;
...
public class ClienteInsertValidator implements ConstraintValidator<ClienteInsert,ClienteNewDTO> {
	...
	public boolean isValid(ClienteNewDTO objDto, ConstraintValidatorContext context) {
		...
		for (FieldMessage e : list) {
			...
			context.buildConstraintViolationWithTemplate(e.getMessagem())
